...
if st.button("Start quiz"):
    ...
    for rij in random_10_vragen:
        ...
        combined_mp3 += vraag_audio + pauze_audio + pauze_audio + pauze_audio + pauze_audio + pauze_audio +  pauze_audio + pauze_audio + pauze_audio + pauze_audio + pauze_audio + antwoord_audio + volgende
